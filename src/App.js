    ...
    <div>
      ...
      <div className='welcome-container' id="inicio">
        <div style={{ userSelect: 'none' }}>
          ...
          <div className='ornament-pan-uno' style={{ userSelect: 'none' }}>
            <img
              src={require('./images/pan-dibujo-3.png')}
              alt='Decorado Olas'
              onContextMenu={(e) => e.preventDefault()}
              onDragStart={(e) => e.preventDefault()}
            />
          </div>
          <div className='ornament-pan-dos' style={{ userSelect: 'none' }}>
            <img
              src={require('./images/pan-dibujo-5.png')}
              alt='Decorado Olas'
              onContextMenu={(e) => e.preventDefault()}
              onDragStart={(e) => e.preventDefault()}
            />
          </div>
          <div className='ornament-pan-tres' style={{ userSelect: 'none' }}>
            <img
              src={require('./images/pan-dibujo-6.png')}
              alt='Decorado Olas'
              onContextMenu={(e) => e.preventDefault()}
              onDragStart={(e) => e.preventDefault()}
            />
          </div>
          <div className='ornament-pan-cuatro' style={{ userSelect: 'none' }}>
            <img
              src={require('./images/pan-dibujo-8.png')}
              alt='Decorado Olas'
              onContextMenu={(e) => e.preventDefault()}
              onDragStart={(e) => e.preventDefault()}
            />
          </div>
          <div className='ornament-pan-cinco' style={{ userSelect: 'none' }}>
            <img
              src={require('./images/pan-dibujo-1.png')}
              alt='Decorado Olas'
              onContextMenu={(e) => e.preventDefault()}
              onDragStart={(e) => e.preventDefault()}
            />
          </div>
          <div className='ornament-pan-seis' style={{ userSelect: 'none' }}>
            <img
              src={require('./images/pan-dibujo-2.png')}
              alt='Decorado Olas'
              onContextMenu={(e) => e.preventDefault()}
              onDragStart={(e) => e.preventDefault()}
            />
          </div>
          <div className='ornament-pan-siete' style={{ userSelect: 'none' }}>
            <img
              src={require('./images/pan-dibujo-4.png')}
              alt='Decorado Olas'
              onContextMenu={(e) => e.preventDefault()}
              onDragStart={(e) => e.preventDefault()}
            />
          </div>
          <div className='ornament-pan-ocho' style={{ userSelect: 'none' }}>
            <img
              src={require('./images/pan-dibujo-7.png')}
              alt='Decorado Olas'
              onContextMenu={(e) => e.preventDefault()}
              onDragStart={(e) => e.preventDefault()}
            />
          </div>
          <div className='ornament-flecha' style={{ userSelect: 'none' }}>
            <img
              src={require('./images/flecha-dibujo.png')}
              alt='Decorado Olas'
              onContextMenu={(e) => e.preventDefault()}
              onDragStart={(e) => e.preventDefault()}
            />
          </div>
          <div className='ornament-panaderia-sello' style={{ userSelect: 'none' }}>
            <img
              src={require('./images/panaderia-sello.png')}
              alt='Decorado Olas'
              onContextMenu={(e) => e.preventDefault()}
              onDragStart={(e) => e.preventDefault()}
            />
